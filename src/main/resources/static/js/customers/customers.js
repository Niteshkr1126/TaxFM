...
function filterUsers() {
    ...
    table = document.querySelector(".table__body table");
...
function sortTable(column, sort_asc) {
    const rowsArray = [...table_rows];  // Convert NodeList to Array

    // Sorting function to sort rows
    rowsArray.sort((a, b) => {
        const first_row = a.querySelectorAll('td')[column].textContent.trim();
        const second_row = b.querySelectorAll('td')[column].textContent.trim();

        // Determine if the data is numeric or string
        const isNumeric = !isNaN(first_row) && !isNaN(second_row);
        if (isNumeric) {
